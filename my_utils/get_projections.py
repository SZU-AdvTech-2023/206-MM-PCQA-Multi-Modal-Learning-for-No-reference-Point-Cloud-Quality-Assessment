...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str,
                        default='G:/database/LS_PCQA/cloudpoint')  # path to the file that contain .ply models
