...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default = 'G:/database/LS_PCQA/distortionpc_all') #path to the file that contain .ply models
    parser.add_argument('--out_path', type=str, default = 'G:/database/LS_PCQA/LS_patch_2048') # path to the output patches
